 ...
 */
public interface MOOSMsgEventListener extends java.util.EventListener {
/**
 *
 * @param messages an array of MOOS messages. This can be an array, or a list or any of the java collection classes.
 */
    public void processMOOSMsg(Iterable<MOOSMsg> messages);
    
     /**
     *
     * @return The message IDs you wish to listen for, as this method will be called by the MOOSCommClient upon connection
     */
    public Iterable<String> getVariableNames();

    /**
     *
     * @return The interval in Seconds of the messages you wish to receive in getVariableNames(). Both Iterable<> arrays should be of same length.
     */
